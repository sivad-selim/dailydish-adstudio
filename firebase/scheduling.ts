...
export type ScheduleReport = {platform?: "instagram" | "facebook" | "all"; permalink?: string; entryId?: string; postId?: string; titles?: Partial<Record<InstagramAccount, string>>; covers?: Partial<Record<InstagramAccount, string>>; id: string; at: number; name: string; account: string; kind: string; message: string};
export type ScheduledAttempt = {platform?: "instagram" | "facebook"; entryId: string; account: InstagramAccount; status: string; startedAt?: number};
